...
export const initialSections: HomepageSection[] = [
  ...
  },
  {
    ...
    content: {
      heading: 'Our Custom Work',
      description: 'Explore outfits made specifically for our clients, from bridal sets to festive evening wear.',
...
export const initialSeoConfig: SeoConfig = {
  global: {
    ...
    keywords: [
      ...
      'wedding sarees kottayam',
      'custom stitching kottayam',
      'bridal blouse embroidery kottayam',
    ...
    canonical_base: 'https://fairyfindsboutique.store',
  },
  local_business: {
    ...
    price_range: '₹₹',
    payment_accepted: 'Cash, UPI, GPay, PhonePe, Credit Card, Debit Card, Net Banking',
    areas_served: ['Kottayam', 'Kerala', 'India', 'UAE / Gulf Diaspora', 'Worldwide'],
  },
  pages: {
    home: {
...
export const initialSettings: StoreSettings = {
  whatsapp_number: '+916282629144',
  store_name: 'Fairy Finds Boutique',
  contact_email: 'hello@fairyfindsboutique.com',
  instagram_url: 'https://instagram.com/fairyfinds.boutique',
  address: 'Fairy Finds Boutique, Neendoor, Kottayam, Kerala',
  announcement_bar: 'Free Delivery above Rs. 2,000 Order • Order Directly via WhatsApp',
  currency_symbol: 'Rs.',
  seo_config: initialSeoConfig,
};
...
export const initialReviews: CustomerReview[] = [
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1610030469983-98e550d6193c?auto=format&fit=crop&q=80&w=800',
    avatar_url: 'https://images.unsplash.com/photo-1610030469983-98e550d6193c?auto=format&fit=crop&q=80&w=800',
    product_name: 'Crimson Heritage Saree',
    rating: 5,
    comment: 'The Crimson Heritage saree exceeded every expectation. The silk has such a regal weight and the gold zari border caught the light wonderfully at my reception.',
  ...
  {
    id: 'rev-04',
    customer_name: 'Rhea George',
    image_url: 'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?auto=format&fit=crop&q=80&w=800',
    avatar_url: 'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?auto=format&fit=crop&q=80&w=800',
    product_name: 'Banarasi Brocade Top',
    rating: 5,
    comment: 'Fairy Finds is my go-to boutique now. The Banarasi silk crop top paired effortlessly with both my ethnic skirts and modern tailored trousers. 10/10 craftsmanship.',
  ...
  {
    id: 'rev-05',
    customer_name: 'Devika Menon',
    image_url: 'https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?auto=format&fit=crop&q=80&w=800',
    avatar_url: 'https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?auto=format&fit=crop&q=80&w=800',
    product_name: 'Burgundy Pleated Maxi',
    rating: 5,
...
export const initialCustomDesigns: CustomDesign[] = [
  {
    ...
    video_url: 'https://www.instagram.com/reel/C8bridal123/',
    instagram_url: 'https://www.instagram.com/reel/C8bridal123/',
  ...
  },
  {
    ...
    video_url: 'https://www.instagram.com/reel/C9gown456/',
    instagram_url: 'https://www.instagram.com/reel/C9gown456/',
    media_type: 'instagram_reel',
  ...
  },
  {
    ...
    video_url: 'https://www.instagram.com/p/C0festive789/',
    instagram_url: 'https://www.instagram.com/p/C0festive789/',
